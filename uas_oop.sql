...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2025 at 08:29 PM
...
--
ALTER TABLE `penjualan`
  MODIFY `id_sale` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `sale_details`
  MODIFY `id_sale_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
