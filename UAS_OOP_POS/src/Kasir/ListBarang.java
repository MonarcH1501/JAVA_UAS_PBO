...
public class ListBarang extends javax.swing.JFrame {
    ...
    public void loadData(){
        ...
        try {
            ...
            o[0] = r.getString("id_product"); 
            o[1] = r.getString("id_supplier"); 
            o[2] = r.getString("product_code"); 
            o[3] = r.getString("product_name");
            o[4] = r.getString("price_sell");  
    ...
    try {
        Connection c = DBConnection.getConnection();
        String sql = "SELECT * FROM product WHERE product_code LIKE '%" + txCari.getText() + "%'" +
                " OR product_name LIKE '%" + txCari.getText() + "%'";
